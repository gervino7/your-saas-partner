...
export const PLANS: Record<PlanId, Plan> = {
  free: {
    ...
    maxUsers: 5, maxMissions: 1, maxStorageGb: 2,
    features: ['1 mission', '5 utilisateurs', '2 Go de stockage'],
  },
  starter: {
    id: 'starter', name: 'Starter', price: 49000,
    maxUsers: 15, maxMissions: 5, maxStorageGb: 50,
    features: ['5 missions', '15 utilisateurs', '50 Go de stockage', 'COPIL & CODIR'],
  },
  pro: {
    id: 'pro', name: 'Pro', price: 149000,
    maxUsers: 50, maxMissions: 25, maxStorageGb: 200,
    features: ['25 missions', '50 utilisateurs', '200 Go', 'Tracking emails', 'Timesheet'],
  },
  business: {
    id: 'business', name: 'Business', price: 299000,
    maxUsers: 200, maxMissions: 9999, maxStorageGb: 1024,
...
export const formatFcfa = (n: number) =>
  n === 0 ? 'Gratuit' : `${n.toLocaleString('fr-FR')} FCFA/mois`;

export const SUPER_ADMIN_EMAILS = ['gervais@abodje.com', 'admin@d-gconseil.com'];
